...
CREATE TABLE IF NOT EXISTS well_hole_section_data (
  ...
  bit1_brand TEXT NULL,
  bit1_kind TEXT NULL,
  bit1_type TEXT NULL,
  bit1_iadc TEXT NULL,
  bit1_serial TEXT NULL,
  bit2_brand TEXT NULL,
  bit2_kind TEXT NULL,
  bit2_type TEXT NULL,
  bit2_iadc TEXT NULL,
  bit2_serial TEXT NULL,

  personnel_day_dd_1 TEXT NULL,
  personnel_day_dd_2 TEXT NULL,
  personnel_day_dd_3 TEXT NULL,
  personnel_night_dd_1 TEXT NULL,
  personnel_night_dd_2 TEXT NULL,
  personnel_night_dd_3 TEXT NULL,
  personnel_day_mwd_1 TEXT NULL,
  personnel_day_mwd_2 TEXT NULL,
  personnel_day_mwd_3 TEXT NULL,
  personnel_night_mwd_1 TEXT NULL,
  personnel_night_mwd_2 TEXT NULL,
  personnel_night_mwd_3 TEXT NULL,
  ...
  ta_standby_time_hrs_run1 REAL NULL,
  ta_standby_time_hrs_run2 REAL NULL,
  ta_standby_time_hrs_run3 REAL NULL,
  ta_ru_time_hrs_run1 REAL NULL,
  ta_ru_time_hrs_run2 REAL NULL,
  ta_ru_time_hrs_run3 REAL NULL,
  ta_tripping_time_hrs_run1 REAL NULL,
  ta_tripping_time_hrs_run2 REAL NULL,
  ta_tripping_time_hrs_run3 REAL NULL,
  ta_circulation_time_hrs_run1 REAL NULL,
  ta_circulation_time_hrs_run2 REAL NULL,
  ta_circulation_time_hrs_run3 REAL NULL,
  ta_rotary_time_hrs_run1 REAL NULL,
  ta_rotary_time_hrs_run2 REAL NULL,
  ta_rotary_time_hrs_run3 REAL NULL,
  ta_rotary_meters_run1 REAL NULL,
  ta_rotary_meters_run2 REAL NULL,
  ta_rotary_meters_run3 REAL NULL,
  ta_sliding_time_hrs_run1 REAL NULL,
  ta_sliding_time_hrs_run2 REAL NULL,
  ta_sliding_time_hrs_run3 REAL NULL,
  ta_sliding_meters_run1 REAL NULL,
  ta_sliding_meters_run2 REAL NULL,
  ta_sliding_meters_run3 REAL NULL,
  ta_npt_due_to_rig_hrs_run1 REAL NULL,
  ta_npt_due_to_rig_hrs_run2 REAL NULL,
  ta_npt_due_to_rig_hrs_run3 REAL NULL,
  ta_npt_due_to_motor_hrs_run1 REAL NULL,
  ta_npt_due_to_motor_hrs_run2 REAL NULL,
  ta_npt_due_to_motor_hrs_run3 REAL NULL,
  ta_npt_due_to_mwd_hrs_run1 REAL NULL,
  ta_npt_due_to_mwd_hrs_run2 REAL NULL,
  ta_npt_due_to_mwd_hrs_run3 REAL NULL,
  ta_brt_hrs_run1 REAL NULL,
  ta_brt_hrs_run2 REAL NULL,
  ta_brt_hrs_run3 REAL NULL,
